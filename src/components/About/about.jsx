            ...
            <div className="row">
                <div className="mx-auto">
                    ...
                    <div className="col-md-6 pt-5 pt-lg-0 order-2 order-lg-1 mt-50 d-flex justify-content-center flex-column">
                        <h3> <strong className='brand-name'>SMARTEARNINGS</strong></h3>
                        <p className="my-3">SMART EARNINGS was established on 19 November 2021 by Ritik Jain and Anushka Maheshwari, To provide solutions for
              ...
              daily updated stuff makes it more attractive. Our team's expertise in the different UHRS tasks makes it easy for the customers to learn and earn.
                        ...
                        <p className="my-3">UHRS stands for Universal Human Relevance System. It’s a web-based platform for online work. It gives you the opportunity to earn money from home by completing short (and often repetitive) tasks.
